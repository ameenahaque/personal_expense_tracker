...
fn bapc(
    ...
    loop {
        ...
        match input.as_str() {
            "1" => {
                println!(
                    "Current Expense on Beauty and Personal Care (BAPC): Rs{:.2}",
                    *bapc_rs
                );
            }
                    ...
                    Ok(amount) => {
                        ...
                        *bapc_rs += amount;
                        ...
                        bapc_list.push(format!(
                            "You spent Rs{:.2} on Beauty and Personal Care (BAPC) on {}",
                            amount, date
                        ));
...
fn add_expense(
    ...
    loop {
        ...
        ║ [5] Education                                     ║
        ║ [6] Entertainment                                 ║
        ║ [7] Beauty and Personal Care (BAPC)               ║
        ║ [8] Exit                                          ║
        ╚═══════════════════════════════════════════════════╝
        "#);
